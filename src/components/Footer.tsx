...
export default function Footer() {
  return (
    <footer className="bg-yb-navy text-yb-beige py-16 border-t border-yb-beige/20">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-yb-beige/80 text-sm mb-6 max-w-md">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-4 text-yb-beige">Quick Links</h3>
            <ul className="space-y-2">
              {navigationLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-yb-beige/80 hover:text-yb-beige transition-colors text-sm"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Trust & Newsletter */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-4 text-yb-beige">Stay Connected</h3>
            
            {/* Newsletter Signup */}
            <div className="mb-6">
              <p className="text-yb-beige/80 text-sm mb-3">
              ...
              <form className="flex flex-col space-y-2">
                <input
                  ...
                  className="px-3 py-2 rounded-md text-yb-navy text-sm focus:outline-none focus:ring-2 focus:ring-yb-beige bg-yb-beige placeholder-yb-navy/60"
                />
                <button
                  type="submit"
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-yb-beige/80 text-xs">SSL Secure</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 bg-yb-beige rounded-full"></div>
                <span className="text-yb-beige/80 text-xs">Privacy Protected</span>
              </div>
            </div>
          </div>
        </div>
