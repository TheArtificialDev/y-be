      ...
      <Section background="white" padding="xl">
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <Card className="p-8 bg-gray-50 hover:bg-gray-100 transition-all duration-300">
              <h3 className="font-heading text-2xl font-bold text-gray-600 mb-6">Generic Solutions</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 mt-1">✗</span>
                  <span className="text-gray-600">Template-based designs that look like everyone else&apos;s</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 mt-1">✗</span>
                  <span className="text-gray-600">No competitive analysis or market research</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 mt-1">✗</span>
                  <span className="text-gray-600">Generic messaging that doesn&apos;t differentiate</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 mt-1">✗</span>
                  <span className="text-gray-600">Limited data insights and optimization</span>
                </li>
              </ul>
            </Card>
            
            <Card className="p-8 bg-yb-beige bg-opacity-20 hover:bg-opacity-30 transition-all duration-300 border-yb-beige">
              <h3 className="font-heading text-2xl font-bold text-yb-navy mb-6">Y-Be Solutions</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-yb-navy">Custom designs based on competitor analysis</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-yb-navy">Deep market research and positioning strategy</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-yb-navy">Messaging that highlights your unique advantages</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 mt-1">✓</span>
                  <span className="text-yb-navy">Continuous optimization based on real data</span>
                </li>
              </ul>
            </Card>
          </div>
      ...
      <Section background="white" padding="xl">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 group hover:bg-yb-beige hover:bg-opacity-20 transition-all duration-300 cursor-pointer">
              <div className="text-center">
                <div className="w-16 h-16 bg-yb-beige rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-yb-navy group-hover:text-yb-beige transition-all duration-300">
                  <span className="text-yb-navy font-bold text-2xl group-hover:text-yb-beige">🎨</span>
                </div>
                <h3 className="font-heading text-xl font-semibold text-yb-navy mb-4">
                  Creative Design
                </h3>
                <p className="text-yb-navy-light text-sm mb-4">
                  Custom designs that reflect your competitive positioning
                </p>
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="text-xs text-yb-navy bg-yb-beige bg-opacity-50 rounded p-2">
            ...
            <Card className="p-6 group hover:bg-yb-beige hover:bg-opacity-20 transition-all duration-300 cursor-pointer">
              <div className="text-center">
                <div className="w-16 h-16 bg-yb-beige rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-yb-navy group-hover:text-yb-beige transition-all duration-300">
                  <span className="text-yb-navy font-bold text-2xl group-hover:text-yb-beige">🏷️</span>
                </div>
                <h3 className="font-heading text-xl font-semibold text-yb-navy mb-4">
                  Strategic Branding
                </h3>
