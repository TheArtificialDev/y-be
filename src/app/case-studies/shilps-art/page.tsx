...
export default function ShilpsArt() {
  ...
  const projectData = {
    ...
    focus: 'Branding & Website',
    description: 'Brand identity and digital presence for an authentic Indian arts school. Created a culturally rich website showcasing traditional art forms and modern teaching methods.',
    challenges: [
      'No established digital brand identity',
      'Traditional art forms needed modern presentation',
      'Showcasing diverse art programs effectively',
      'Attracting students interested in Indian culture'
    ],
    solutions: [
      'Cultural brand identity reflecting Indian artistry',
      'Visual portfolio showcasing student artwork',
      'Program descriptions with cultural context',
      'Online inquiry system for art classes'
    ],
    impact: {
      'Brand Recognition': { before: 'Local word-of-mouth', after: 'Digital brand presence', improvement: 'Online visibility' },
      'Student Inquiries': { before: '8/month', after: '22/month', improvement: '+175%' },
      'Program Showcase': { before: 'Physical portfolio', after: 'Interactive gallery', improvement: 'Digital transformation' },
      'Cultural Reach': { before: 'Neighborhood only', after: 'City-wide interest', improvement: 'Expanded audience' }
    },
    technologies: ['Brand Design', 'WordPress', 'Gallery Systems', 'Cultural UI/UX'],
    timeline: '4 weeks',
    teamSize: '2 designers + 1 developer',
          ...
          >
            ...
            <div className={`grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12 transition-all duration-1000 ease-out ${
              ...
              <div className="text-center p-4">
                <div className="text-3xl font-bold text-yb-beige mb-2">+175%</div>
                <div className="text-sm text-yb-beige-light">Student Inquiries</div>
              </div>
              <div className="text-center p-4">
                <div className="text-3xl font-bold text-yb-beige mb-2">100%</div>
                <div className="text-sm text-yb-beige-light">Digital Transformation</div>
              </div>
              <div className="text-center p-4">
                <div className="text-3xl font-bold text-yb-beige mb-2">City-wide</div>
                <div className="text-sm text-yb-beige-light">Cultural Reach</div>
              </div>
              <div className="text-center p-4">
                <div className="text-3xl font-bold text-yb-beige mb-2">Brand</div>
                <div className="text-sm text-yb-beige-light">Identity Created</div>
              </div>
            </div>
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-yb-navy-light mb-8 text-center max-w-3xl mx-auto">
                Shilps Art needed a complete digital identity to showcase their authentic Indian art education and attract culturally interested students.
              </p>
        ...
        <Container>
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-yb-navy-light mb-8 text-center max-w-3xl mx-auto">
                We created a complete brand identity and digital presence that honors traditional Indian artistry while appealing to modern audiences.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Container>
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-yb-navy-light mb-8 text-center max-w-3xl mx-auto">
                The transformation from traditional word-of-mouth to digital presence yielded significant growth in student interest and enrollment.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Container>
          ...
          >
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mb-12">
                <h3 className="font-semibold text-yb-beige mb-6">Technologies & Services</h3>
